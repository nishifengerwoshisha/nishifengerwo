...
import { tool as addComma } from './add-comma';
import { tool as mermaidView } from './mermaid-view';
import { tool as dateIdGenerator } from './dateid-generator';
...
export const toolsByCategory: ToolCategory[] = [
  {
    name: 'Crypto',
    components: [tokenGenerator, hashText, bcrypt, dateIdGenerator, uuidGenerator, ulidGenerator, cypher, bip39, hmacGenerator, rsaKeyPairGenerator, passwordStrengthAnalyser, pdfSignatureChecker],
  },
  {
    name: 'Converter',
    components: [
